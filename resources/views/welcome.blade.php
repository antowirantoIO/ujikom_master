...
.layout-navbar-fixed .layout-wrapper:not(.layout-horizontal):not(.layout-without-menu) .layout-page {
	padding-top: 25px !important;
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                ...
                >
                  <h3 class="text-center">Cek Status Laundryan Kamu</h3>
                    ...
                    <div class="input-wrapper mb-3 input-group input-group-lg input-group-merge">
                        ...
                        placeholder="Search"
                        name="no_invoice"
                        value="{{ app('request')->input('no_invoice') }}"
                        aria-label="Search"
                        aria-describedby="basic-addon1"
                        />
                    </div>
                    <p class="text-center">Masukan Nomor Invoice Yang Berada Di Bukti Invoice</p>
                ...
                <!-- Popular Articles -->
                <div class="help-center-popular-articles bg-help-centern pt-4">
                  <div class="container-xl">
                    <h3 class="text-center">Status Pesanan</h3>
                    <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="card border shadow-none">
                              <div class="card-body text-center">
                                @if($transaksi)
                                    <div>
                                        <h4 class="fw-semibold mb-2">INVOICE #{{ $transaksi->no_invoice }}</h4>
                                        <div class="mb-2 pt-1">
                                            <span>Tanggal Masuk:</span>
                                            <span class="fw-semibold">{{ $transaksi->tanggal_masuk }}</span>
                                        </div>
                                        <div class="mb-2 pt-1">
                                            <span>Konsumen:</span>
                                            <span class="fw-semibold">{{ $transaksi->konsumen->nama }}</span>
                                        </div>
                                        <div class="mb-2 pt-1">
                                                <span>Status:</span>
                                                    @if($transaksi->status_pesanan->nama == 'BARU')
                                                        <div class="mr-2 badge bg-primary">BARU</div>
                                                    @elseif($transaksi->status_pesanan->nama == 'DIPROSES')
                                                        <div class="mr-2 badge bg-warning">DIPROSES</div>
                                                    @else
                                                        <div class="mr-2 badge bg-success">SELESAI</div>
                                                    @endif
                                            </div>
                                    </div>
                                @else 
                              ...
                              <h5 class="my-2">Data Laundrian</h5>
                              <p>
                                  Data laundryan Kamun akan tampil disini, mulai mencari
                              </p>
